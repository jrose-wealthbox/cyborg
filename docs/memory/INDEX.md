...
| ADR-20260813-cyborg-v2-architecture-approved | decision | active | 2026-08-15T03:12:52Z | 2026-08-15T03:12:52Z | architecture, cyborg v1, bridge, bootstrap, analysis orchestration, budgets, persistence; docs/cyborg-architecture-design-v2-sol-medium.md, lib/cyborg/bootstrap/initializer.rb, skills/cyborg, test/contract, test/system | CYBORG v2 is approved as implementation authority: v1 is a Ruby 4.x modular monolith with SQLite, direct GitHub and local-Git adapters, CLI-owned idempotent bootstrap, a protected host-analysis bridge, stable actions, and persisted Markdown/JSON views. | [entry](decisions/ADR-20260813-cyborg-v2-architecture-approved.md) |
