...
| ADR-20260813-cyborg-v2-architecture-approved | decision | active | 2026-08-13T02:58:45Z | 2026-08-13T02:58:45Z | architecture, cyborg v1, bridge, persistence; docs/cyborg-architecture-design-v2-sol-medium.md, lib/cyborg, db/migrations, skills/cyborg | CYBORG v2 is approved as implementation authority: v1 is a Ruby 4.x modular monolith with SQLite, direct GitHub and local-Git adapters, a protected host-analysis bridge, stable actions, and persisted Markdown/JSON views. | [entry](decisions/ADR-20260813-cyborg-v2-architecture-approved.md) |
